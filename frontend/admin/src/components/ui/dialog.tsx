...
/**
 * DialogOverlay - dark backdrop behind dialog
 * Prevents interaction with content underneath
 */
...
/**
 * DialogTitle - main heading in dialog
 */
...
/**
 * DialogDescription - subtitle or description text
 */
