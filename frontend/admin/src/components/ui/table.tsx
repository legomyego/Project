...
// Works great with TanStack Table for sorting, filtering, and pagination
 ...
 * Sets width to 100% and caption placement
 */
 ...
 * Contains footer content like totals
 */
