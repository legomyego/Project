...
namespace RecipesApi.Migrations
{
    ...
    [Migration("20260113194801_AddPasswordResetTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecipesApi.Models.SubscriptionRecipe", b =>
                {
                    ...
                    b.HasKey("SubscriptionId", "RecipeId");
            ...
            modelBuilder.Entity("RecipesApi.Models.SubscriptionRecipe", b =>
                {
                    b.HasOne("RecipesApi.Models.Recipe", "Recipe")
                        .WithMany("SubscriptionRecipes")
                        .HasForeignKey("RecipeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RecipesApi.Models.Subscription", "Subscription")
                        .WithMany("SubscriptionRecipes")
            ...
            modelBuilder.Entity("RecipesApi.Models.Recipe", b =>
                {
                    b.Navigation("SubscriptionRecipes");
                });
